...
<%
	...
	try {
		...
		/*
		out.println("支付後傳入的基本參數" + "<br/>");
		out.println("AllPayURL = " + (String) session.getAttribute("AllPayURL") + "<br/>");
		out.println("HashKey = " + oPayment.HashKey + "<br/>");
		out.println("HashIV = " + oPayment.HashIV + "<br/>");
		out.println("<br/>");
		//*/
		...
		out.println("hasMoreElements: " + request.getParameterNames().hasMoreElements() + "<br/>");
		out.println("<br/>");
		//*/
